...
The 30-meter band (10.1-10.15 MHz) is a relatively narrow band with a primary allocation to the fixed service internationally, with amateur radio as secondary. To minimize potential interference, phone operation is not permitted on this band—only CW and data modes are allowed.
