...
Un mensaje transmitido por un operador de control de una estación de radioaficionado a otro operador de control de estación de radioaficionado en nombre de otra persona.

#### U

##### ULS (Sistema Universal de Licencias)
...
##### UHF (Ultra Alta Frecuencia) {#glossary-uhf}
La banda de frecuencia de radio entre 300 MHz y 3 GHz. Comúnmente utilizada para comunicación local, incluyendo radios portátiles y repetidores.

#### V

##### Vanity Call Sign (Indicativo de Llamada Personalizado)
Un indicativo de llamada personalizado elegido por un operador con licencia. Ver Sección 8.1.

##### VHF (Muy Alta Frecuencia) {#glossary-vhf}
La banda de frecuencia de radio entre 30 y 300 MHz.

##### VoIP (Voz sobre Protocolo de Internet)
Un método para entregar comunicaciones de voz a través de Internet utilizando técnicas digitales.

#### Códigos Especiales y Abreviaturas

##### 73
Una despedida tradicional de radioafición que significa "saludos cordiales" o "adiós".

##### 88
Una despedida amistosa que significa "besos y abrazos", a menudo utilizada entre radioaficionados que se conocen bien.
...
##### QSL
Acuse de recibo o entendimiento.
