...
> **Key Information:** You receive official notification of your new license and call sign via *email from the FCC with a link to download the license grant*. {{< link id="T1A04" >}}
...
> **Key Information:** You can renew your license as early as *ninety (90) days* before it expires. {{< link id="T1C07" >}}
...
> **Key Information:** *Willful or malicious interference* to other amateur radio stations is *prohibited*—always, under all circumstances. {{< link id="T1A11" >}}
...
> **Key Information:** *Any amateur station* may be remotely controlled. {{< link id="T1E09" >}}
...
> **Key Information:** The function of the *Variable Frequency Oscillator (VFO)* is to *set the receive and transmit frequency*. {{< link id="T7A11" >}}
...
> **Key Information:** An ohmmeter measures resistance by *applying a small current and measuring the resulting voltage*. {{< link id="T7D05" >}}
...
> **Key Information:** A typical RF dummy load consists of a *50-ohm non-inductive resistor mounted on a heat sink*. {{< link id="T7C03" >}}
...
> **Key Information:** *High SWR* is a common cause of *low RF power output* from a solid-state transceiver. {{< link id="T7B04" >}}
...
> **Key Information:** Adding a *clip-on ferrite choke to the microphone cable* can eliminate distorted voice transmissions by preventing RF feedback into the transmitter. {{< link id="T7B11" >}}
...
> **Key Information:** Technician class operators can use digital modes such as FT8 on *10 meters, 6 meters, and 2 meters*. {{< link id="T1B05" >}}
...
> **Key Information:** For FT8 operation, the transceiver's audio input and output connect to the *audio output and input of a computer running FT8 software*. {{< link id="T4A04" >}}
...
> **Key Information:** Talking *too loudly* will cause your FM transmission audio to *drop out on voice peaks*. {{< link id="T2B05" >}}
...
> **Key Information:** A DMR *"code plug"* is *configuration data loaded onto your radio to access repeaters and talkgroups*. {{< link id="T4B07" >}}
