...
> - The control operator of a station communicating through an amateur satellite or space station can be any amateur allowed to transmit on the satellite uplink frequency. {{< link id="T1E02" >}} In practice, this means any Technician class or higher operator, since the bands typically used for satellite uplinks are within Technician privileges.
> - Any amateur with a Technician class or higher license may contact the International Space Station (ISS) on VHF bands. {{< link id="T1B02" >}}
...
> **Key Information:**
> - LEO stands for Low Earth Orbit, which has a period of around 100 minutes. {{< link id="T8B10" >}}
> - When a satellite is operating in U/V mode, the uplink is in the 70-centimeter band and the downlink is in the 2-meter band. {{< link id="T8B08" >}}
> - Amateur radio satellites commonly use SSB, FM, and CW/data modes. {{< link id="T8B04" >}}
...
> **Key Information:**
> - A satellite beacon is a transmission from a satellite that contains status information — typically reporting the health and status of the satellite. {{< link id="T8B05" >}} {{< link id="T8B01" >}}
