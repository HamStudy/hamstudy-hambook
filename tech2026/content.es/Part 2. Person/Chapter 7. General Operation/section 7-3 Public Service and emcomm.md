...
> **Nota: ARES vs. RACES**
> ARES es una organización voluntaria de operadores aficionados que proporciona comunicaciones de servicio público, mientras que RACES es un servicio regulado por la FCC específicamente para comunicaciones de defensa civil durante emergencias nacionales. Es fácil confundirlos: el requisito de inscripción por una agencia de defensa civil es la forma más sencilla de distinguirlos.
...
> **Información Clave:** En la operación de redes, el término "tráfico" se refiere a mensajes formales intercambiados por las estaciones de la red. {{< link id="T2C05" >}}
...
> **Información Clave:**
> - El preámbulo de un mensaje de tráfico formal contiene información necesaria para rastrear el mensaje. {{< link id="T2C10" >}}
> - El "check" en el encabezado de un radiograma es el número de palabras o equivalentes de palabras en la parte de texto del mensaje. {{< link id="T2C11" >}}
...
> **Información Clave:** Winlink retransmite mensajes usando direcciones de correo electrónico basadas en indicativos de radioaficionado. {{< link id="T2C08" >}}
