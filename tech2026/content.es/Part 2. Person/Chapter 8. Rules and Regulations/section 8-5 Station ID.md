...
> **Información Clave:** Debes transmitir tu indicativo asignado al menos cada 10 minutos durante una comunicación y al final de cada comunicación. {{< link id="T1F03" >}}
...
> **Información Clave:** Cuando hagas transmisiones de prueba al aire, debes identificar la estación transmisora. {{< link id="T1D12" >}}
...
> **Información Clave:** Cuando usas una transmisión de voz, puedes usar stroke, slant o slash indistintamente para indicar el separador en un indicador autoasignado. {{< link id="T1F06" >}}
