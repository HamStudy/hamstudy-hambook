...
![Dos operadores de radioafición caricaturescos con cascos y arneses de seguridad de pie frente a una torre de antena, ambos levantando el pulgar; una cuerda enrollada yace en el suelo entre ellos](../../../images/illus/tower_illus.svg)
{.img-pgcap .float-right}

> **Información clave:**
> - Al escalar una torre de antena, debes tener capacitación suficiente en técnicas seguras de escalada de torres, usar sujeción apropiada a la torre en todo momento y usar siempre un arnés de escalada aprobado. {{< link id="T0B02" >}}
> - Nunca es seguro escalar una torre sin un ayudante u observador. {{< link id="T0B03" >}}
...
> **Información clave:** Una precaución de seguridad importante al instalar una torre de antena es buscar y mantenerse alejado de cualquier cable eléctrico aéreo. {{< link id="T0B04" >}}

> **Información clave:** La distancia mínima segura desde una línea eléctrica al instalar una antena es suficiente para que, si la antena cae, ninguna parte de ella pueda quedar a menos de 10 pies de los cables eléctricos. {{< link id="T0B06" >}}
...
> **Información clave:** Debes evitar sujetar una antena a un poste de servicios públicos porque la antena podría hacer contacto con líneas eléctricas de alto voltaje. {{< link id="T0B09" >}}
...
> **Información clave:** Los requisitos de puesta a tierra para una torre o antena de radioaficionado son establecidos por los códigos eléctricos locales. {{< link id="T0B11" >}}
