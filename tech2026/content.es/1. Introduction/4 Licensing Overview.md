...
1. **Clase Technician**: Esta es la licencia de nivel de entrada y el enfoque de este libro. Proporciona privilegios de operación en todas las bandas de radioaficionados VHF y UHF y algunos privilegios limitados en bandas HF.
...
Si alguna vez tuviste una licencia de clase General o Amateur Extra, puedes recuperar tus privilegios anteriores después de aprobar solamente el examen de licencia de clase Technician — ¡habla con tu equipo de VE para obtener más información!
...
Recuerda que incluso si encuentras la sesión de examen a través de HamStudy u otro sitio web, estos simplemente listan sesiones de examen para un equipo específico de Examinadores Voluntarios — necesitas contactar a ese equipo directamente con cualquier pregunta. Si te registras para el examen a través de HamStudy.org, por ejemplo, deberías recibir un correo electrónico de registro al que puedes responder para contactar al equipo de VE.
...
Al registrarte para un examen remoto, lee cuidadosamente todas las instrucciones proporcionadas por el equipo de examen. Presta atención a cualquier requisito de software específico o procedimiento previo al examen que puedan tener.

---

Eso cubre qué esperar del proceso de licenciamiento en sí. Con ese contexto establecido, el próximo capítulo comienza la Parte 1 — la ciencia detrás de la radioafición, empezando con los principios eléctricos.
