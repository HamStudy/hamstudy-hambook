...
> - Las señales UHF rara vez se escuchan más allá de su horizonte de radio porque por lo general no son propagadas por la ionosfera. {{< link id="T3C01" >}}
...
La línea de vista es como poder ver a alguien al otro lado de un campo: si puedes verlo, por lo general puedes comunicarte con él. Sin embargo, varios efectos importantes pueden ayudar o dificultar esta propagación básica:
...
> - El **efecto de valla** (*picket fencing*) es el aleteo rápido en señales móviles debido a la propagación multitrayecto. {{< link id="T3A06" >}}
...
Para los modos digitales, el multitrayecto puede ser especialmente problemático: las señales que llegan por diferentes caminos pueden interferir entre sí y aumentar las tasas de error, por lo que la mayoría de los modos digitales incluyen detección y corrección de errores.
...
Una forma especial de onda espacial que conviene conocer es la propagación auroral. Cuando las señales se reflejan en la aurora, se distorsionan, con un sonido áspero característico. {{< link id="T3C03" >}} — la aurora es como una cortina brillante y móvil que refleja señales de manera impredecible.
...
La Esporádica E ocurre cuando parches aleatorios de la capa E de la ionosfera se cargan temporalmente — como una nube de partículas ionizadas que aparece y desaparece en la atmósfera superior. Cuando se forma uno, puede reflejar señales mucho más lejos de lo normal por un breve tiempo, dándote contactos inesperados de larga distancia. No puedes predecir exactamente cuándo ocurrirá, pero es una característica regular de la propagación VHF.
